...
{
    public class WorkoutHistoryExerciseRepository(IUnitOfWork unitOfWork) : RepositoryBase<WorkoutHistoryExercise>(unitOfWork), IWorkoutHistoryExerciseRepository
    {
    }
}
