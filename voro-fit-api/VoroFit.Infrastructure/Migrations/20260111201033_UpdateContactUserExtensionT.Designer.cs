...
namespace VoroFit.Infrastructure.Migrations
{
    ...
    [Migration("20260111201033_UpdateContactUserExtensionT")]
    partial class UpdateContactUserExtensionT
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VoroFit.Domain.Entities.Evolution.Contact", b =>
                {
                    b.HasOne("VoroFit.Domain.Entities.UserExtension", "UserExtension")
                        .WithOne("Contact")
                        .HasForeignKey("VoroFit.Domain.Entities.Evolution.Contact", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
