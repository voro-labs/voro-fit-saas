...
```
{
  ...
  "EvolutionSettings:BaseWebhookUrl": "http://host.docker.internal:5251/api/v1/webhook",
  "EvolutionSettings:BaseUrl": "http://localhost:8080",
  "EvolutionSettings:Key": "EVOLUTION-KEY"
}
```
